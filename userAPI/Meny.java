    ...
    public static void main(String[] args) throws Exception {
        ...
        switch (val) {
            case 1:
                ...
                break;
            case 2:
                valString = "Återlämna bok";
                break;
            case 3:
                valString = "Avsluta konto";
                break;
            case 4:
                valString = "Registrera konto";
                break;
            case 5:
                valString = "Svartlista medlem";
                break;
            case 6:
                valString = "Temporär avstängning";
                break;
            case 7:
                valString = "Kolla Tillgänglighet ";
                break;
            default:
                valString = "Invalid val!";
                        ...
                        try {
                            ...
                            while (kontoStatusSvar == 0 ) {
                                ...
                                if (tillgänglighetsvar > 0) {
                                    ...
                                    System.out.println("Boken " + " lånad!");
                                }
